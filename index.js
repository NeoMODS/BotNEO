...
ConfuMods = [`12706058584@s.whatsapp.net`] 
prefix = '#'
blocked = []
fake = 'NeoBot'
...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:NEO\n' 
            + 'ORG:NEO\n' 
            + 'TEL;type=CELL;type=VOICE;waid=12706058584:+12706058584\n' 
            + 'END:VCARD' 
...
🈳⊳SUSCRIBETE A MI CANAL OFICIAL EN EL SIGUIENTE ENLACE📱↓↓
...
if (!isRegistered) return reply(ind.noregis())			  
            ...
            cnf.sendMessage(from,media,image,{quoted:mek,caption:'NeoBot'})
            }
            )
            .catch((error) => {
            console.log(error); 
...
if (!isRegistered) return reply(ind.noregis())			  
                if (!mek.key.fromMe) return reply('*𝐬𝐨𝐥𝐨 𝐪𝐮𝐢𝐞𝐧 𝐝𝐞𝐬𝐚𝐫𝐫𝐨𝐥𝐥𝐨 𝐞𝐥 𝐛𝐨𝐭 𝐩𝐮𝐞𝐝𝐞 𝐮𝐬𝐚𝐫 𝐞𝐬𝐭𝐞 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 𝐚𝐦𝐢𝐤𝐨 𝐮𝐧𝐮*')
	        await cnf.sendMessage(from, `Bye...\n_NeoBot apagandose..._`, text,{quoted : freply})
		await sleep(3000)
                cnf.close()
		addFilter(from)
          break
...
if (!isRegistered) return reply(ind.noregis())			  
				if (mek.message.extendedTextMessage != undefined){
					...
					cnf.sendMessage(from, thumb, MessageType.image, {quoted: mek, caption: `NeoBot`})}
				addFilter(from)
          break
...
if (!isRegistered) return reply(ind.noregis())			  	
				...
				buffer = fs.readFileSync(ran)
				cnf.sendMessage(from, buffer, image, {quoted: mek, caption: 'NeoBot'})
				fs.unlinkSync(ran)
			    })
...
• Limit: ${limitawal-updated.limit}`
          ...
          break
                ...
                addKoinUser('+12706058584@s.whatsapp.net', fee)
...
case prefix+'tagall2':
				...
				cnf.updatePresence(from, Presence.composing) 
					...
					cnf.sendMessage(from, 'Mencionando a todos OwO'+teks+'✪ NeoBot ✪', text, {quoted: mek})
					addFilter(from)
          break
                case prefix+'tagall3':
                case prefix+'marcar3':
